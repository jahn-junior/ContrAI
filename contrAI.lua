        ...
        for s = 1, numSpecies do
                ...
                for g = 1, numGenomes do
                        ...
                        for n = 1, numGenes do
                                ...
                                local enabled
                                gene.into, gene.out, gene.weight, gene.innovation, enabled = file:read("*number",
...
while true do
        ...
        local fitness = measureFitness()
        if fitness > rightmost then
                rightmost = fitness
                timeout = TimeoutConstant
        end
        ...
        if not forms.ischecked(hideBanner) then
                gui.drawText(0, 0,
                        ...
                        " species " ..
                        pool.currentSpecies ..
                        " genome " .. pool.currentGenome .. " (" .. math.floor(measured / total * 100) .. "%)",
                        0xFF000000, 11)
                gui.drawText(0, 12,
